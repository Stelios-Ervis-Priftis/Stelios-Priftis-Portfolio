		...
		<Layout>
			...
			<section
				...
				<Container
					...
					<div
						className={
							aboutStyles.aboutBio
						}>
						<h2>About Stelios</h2>
						<p>
							I’m a Front - End Developer
							with a background in Sound
							Engineering.
						</p>
						<p>
							When I was working as a Sound
							Engineer I was curious about
							how software programs work.
							So I started doing some
							research and I bumped into an
							enormous amount of courses
							and information about coding
							and what you can achieve with
							it.
						</p>
						<p>
							After dabbling with code in
							my spare time, I realise I
							was hooked and decided to
							take a BootCamp course in
							order to learn how to code
							properly. This has exposed me
							to full-stack technologies
						...
						<p>
							...
							further grow and develop my
							love for coding. Currently, I
							am looking for a job
							opportunity in the field as a
							Front - End Developer that
					...
					<div
						className={`${aboutStyles.scrollDown}`}>
						<span
							className={
								scroll
									? aboutStyles.visible
									: aboutStyles.invisible
							}></span>
					</div>
				</Container>
			</section>
			...
			<section
				className={
					aboutStyles.hobbiesSection
				}>
				<Container
					fluid
					className={
						aboutStyles.hobbiesContainer
					}>
					<h1>My Hobbies</h1>
					<Row
						className={
							aboutStyles.windsurfingRow
						}>
						<Col lg="4">
							<div
								className={
									aboutStyles.windsurfingContainer
								}>
								<Image
						...
						<Col lg="8">
							<div
								...
								<p>
									...
									passion. The rush of
									gliding on water,
									powered by the wind, is
									an exhilarating
									experience like no
									other. It's a constant
									pursuit of mastering
									the elements, pushing
									boundaries, and
					...
					<Row
						className={
							aboutStyles.snowboarderRow
						}>
						<Col lg="8">
							<div
								className={
									aboutStyles.snowboarderBio
								}>
								<h1>Snow Boarding</h1>
								<p>
									Snowboarding is my
									winter passion. The
									sensation of carving
									down pristine slopes,
									surrounded by a winter
									wonderland, is pure
									euphoria. It's a sport
									that combines
									adrenaline and
									artistry, where each
									ride becomes a canvas
									for self-expression.
								</p>
							</div>
						</Col>
						...
						<Col lg="4">
							<div
								className={
									aboutStyles.snowboarderContainer
								}>
								<Image
					...
					<Row
						className={
							aboutStyles.bartendingRow
						}>
						<Col lg="4">
							<div
								className={
									aboutStyles.bartendingContainer
								}>
								<Image
						...
						<Col lg="8">
							<div
								...
								<p>
									...
									voluptate illo, impedit
									quam ipsum ex
									perferendis vel earum
									dolore aut deleniti
									possimus, sapiente
									natus itaque, nobis
									aliquid neque velit
